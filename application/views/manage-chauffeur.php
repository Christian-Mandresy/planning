    ...
    <table class="table table-hover">
      ...
      <?php foreach($chauffeurs as $chauffeur) { ?>
        <tr>
          ...
          <td>
          <a href="<?php echo site_url()?>edit-chauffeur/<?php echo $chauffeur->id?>" >
          <button type="button" class="btn btn-secondary btn-sm">
              Edit
          </button></a>
          <a href="<?php echo site_url()?>delete-chauffeur/<?php echo $chauffeur->id?>" onclick="return confirm('are you sure to delete')">
