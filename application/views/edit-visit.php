<div class="col-md-8">
    <div class="card">
        <form class="form-horizontal" method="post" action="<?php echo site_url()?>/edit-visite-post">
        <div class="card-body">
            <h4 class="card-title">Modifier une visite technique</h4>
            <input
                    type="hidden"
                    class="form-control"
                    id="numero" name="visite_id"
                    value="<?php echo $visite[0]->id ?>"
                    />
            <div class="form-group row">
                ...
                <?php $i=1; foreach($vehicules as $vehicule) { ?> 
                    <?php if($visite[0]->numero == $vehicule->numero) {?>
                ...
                <div class="col-sm-9">
                    <?php if(validation_errors() != false ){ ?>
                        <div class="col-lg-8 col-md-12">
                            ...
                            name="datedebut" value="<?php echo $visite[0]->datedebut ?>"/>
                    ...
                    <?php } else {?>
                        ...
                        value="<?php echo $visite[0]->datedebut ?>"
                        />
                    <?php } ?>
                </div>
                ...
                <div class="col-sm-9">
                    <?php if(validation_errors() != false ){ ?>
                        <div class="col-lg-8 col-md-12">
                            ...
                            name="datefin" value="<?php echo $visite[0]->datefin ?>"/>
                            <div class="invalid-feedback">
                    ...
                    <?php } else {?>
                        ...
                        value="<?php echo $visite[0]->datefin ?>"
                        />
                    <?php } ?>
                </div>
            </div>
