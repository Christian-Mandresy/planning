<div class="col-md-8">
    <div class="card">
        <form class="form-horizontal" method="post" action="<?php echo site_url()?>/add-entretienpiece-post" id="form">
        <input type="hidden" name="profilentretien_id" value="<?php echo $identretien?>">
        <style>
            .btno {
        ...
        <!--- card body avec input dynamique àmanipuler avec précaution
        
        
        --->
        <div class="card-body" id="cardbody">
            <h4 class="card-title">Ajouter Une piece</h4>  
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    name="kilometrage"
                    id="kilometrage"
                    placeholder="Kilometrage avant entretetien"
                    />
                </div>
            </div>
        </div>
        ...
        <script >
            ...
            //h4  / 2(groupe d'input pour une voiture)
            var nombreChild=(cardbody.childElementCount - 1)/2;
            ...
            bouton.addEventListener("click",function () {
                ...
                input.className='select2 form-select shadow-none select2-hidden-accessible';
