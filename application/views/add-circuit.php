<div class="col-md-9">
    <div class="card">
        <form class="form-horizontal" method="post" action="<?php echo site_url()?>/add-circuit-post" id="form">
        <style>
            .btno {
        ...
        <div class="card-body wizard-content" id="cardbody">
                ...
                <?php if(!empty($dataTrajet) ){ ?>
                    <h4 class="card-title">Ajouter Un Circuit</h4>
                        ...
                        <div class="col-sm-9">
                            <?php if(validation_errors() != false ){ ?>
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    name="datedebut"
                                    value="<?php echo $circuit['datedebut'] ?>"
                                    />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <?php if(validation_errors() != false ){ ?>
                                <div class="col-lg-8 col-md-12">
                                    <input type="datetime-local" class="form-control is-invalid" id="datefin" name="datefinc"
                    ...
                    <?php $i=-1;$indice=''; foreach($dataTrajet as $trajet) { ?>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <?php if($i == -1) {?>
                                    <select class="select2 form-select shadow-none select2-hidden-accessible selectpicker" style="width: 100%; height: 36px" data-select2-id="1" tabindex="-1" aria-hidden="true" name="depart">
                                        <?php foreach($lieus as $lieu) { ?>
                                            <?php if($lieu->id == $trajet['depart']) {?>
                                ...
                                <div class="col-md-5">
                                    <?php if(validation_errors() != false ){ ?>
                                        <div class="col-lg-8 col-md-12">
                                            ...
                                            value="<?php  echo $trajet['datedebut']; ?>" />
                                        </div>
                                    <?php } else {?>
                                        <div class="col-lg-8 col-md-12">
                                            <input
                        ...
                        <?php if($i == count($dataTrajet)-2) {?>
                            <div class="form-group row transport">
                                ...
                                <div class="col-md-2">
                                    <div class="form-check">
                                        <?php if($trajet['gestiontransport']=='0') {?>
                                            <input type="radio" class="form-check-input" id="customControlValidation1" name="gestiontransport<?php  echo $indice+1; ?>" required="" value="0" checked>
                                        <?php } else {?>
                                            <input type="radio" class="form-check-input" id="customControlValidation1" name="gestiontransport<?php  echo $indice+1; ?>" required="" value="0">
                                        <?php } ?>
                                    ...
                                    <div class="form-check">
                                        <?php if($trajet['gestiontransport']=='1') {?>
                                            <input type="radio" class="form-check-input" id="customControlValidation2" name="gestiontransport<?php  echo $indice+1; ?>" required=""
                                            value="1" checked>
                                        <?php } else {?>
                                            <input type="radio" class="form-check-input" id="customControlValidation2" name="gestiontransport<?php  echo $indice+1; ?>" required=""
                                            value="1" >
                                ...
                                <div class="col-md-2">
                                    <input type="number" class="form-control" name="place<?php  echo $indice+1; ?>" value="<?php  echo $trajet['place']; ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label
                                ...
                                >
                                <div class="col-md-3">
                                    <select class="select2 form-select shadow-none select2-hidden-accessible" style="width: 100%; height: 36px" data-select2-id="1" tabindex="-1" aria-hidden="true" name="arrive<?php  echo $indice+1; ?>">
                                        <?php foreach($lieus as $lieu) { ?>
                                            <?php if($lieu->id == $trajet['arrive']) {?>
                                                <option value="<?php echo $lieu->id?>" selected ><?php echo $lieu->nom?></option>
                                            <?php } else {?>
                                                <option value="<?php echo $lieu->id?>" ><?php echo $lieu->nom?></option>
                                            <?php } ?>  
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php } else {?>
                                            <div class="col-lg-8 col-md-12">
                                                ...
                                                type="datetime-local"
                                                class="form-control"
                                                id="datefin" name="datefin<?php  echo $indice+1; ?>"
                                                value="<?php  echo $trajet['datefin']; ?>"
                                                />
                                                <div class="invalid-feedback">
                                                <?php echo form_error('datefin'); ?>
                ...
                <?php } else {?>
                    <h4 class="card-title">Ajouter Un Circuit</h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?php if(validation_errors() != false ){ ?>
                                    <div class="col-lg-8 col-md-12">
                                        <input type="datetime" class="form-control is-invalid" id="datedebut" name="datedebut"/>
                                        <div class="invalid-feedback">
                                        <?php echo form_error('datedebut'); ?>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <?php if(validation_errors() != false ){ ?>
                                    <div class="col-lg-8 col-md-12">
                                        <input type="datetime" class="form-control is-invalid" id="datefin" name="datefin"/>
                                        <div class="invalid-feedback">
                                        <?php echo form_error('datefin'); ?>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        >
                        <div class="col-md-3">
                        <select class="select2 form-select" style="width: 100%; height: 36px" name="depart">
                            <?php foreach($lieus as $lieu) { ?>  
                            <option value="<?php echo $lieu->id?>" ><?php echo $lieu->nom?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group row">
                        ...
                        >
                        <div class="col-md-3">
                        <select class="select2 form-select" style="width: 100%; height: 36px" data-select2-id="1" tabindex="-1" aria-hidden="true" name="arrive">
                            <?php foreach($lieus as $lieu) { ?>  
                            <option value="<?php echo $lieu->id?>" ><?php echo $lieu->nom?></option>
                            <?php } ?>
                        </select>
        ...
        <script >
            ...
            bouton.addEventListener("click",function () {
                ...
                input.className='select2 form-select';
                ...
                $('.select2').select2();
                console.log(nombreChild);
                console.log('tena izy : ',(cardbody.childElementCount - 6)/2);
            ...
            boutondelete.addEventListener("click",function () {
                if(nombreChild>1)
                {
                    console.log('voalohany',cardbody.lastElementChild);
                    cardbody.removeChild(cardbody.lastElementChild);
                    console.log('faharoa',cardbody.lastChild);
                    cardbody.removeChild(cardbody.lastElementChild);
                    nombreChild-=1;
                    console.log(nombreChild);
                    console.log('tena izy : ',(cardbody.childElementCount - 6)/2);
