...
<div class="col-md-8">
    <div class="card">
        <form class="form-horizontal" method="post" action="<?php echo site_url()?>/add-vehicule-prestataire-post">
        <div class="card-body" id="card-body">
            <h4 class="card-title">Ajout vehicule</h4>
            <input type="hidden" value="<?php echo $prestataire_id ?>"   name="prestataire_id">
        ...
        <script >
            ...
            var nombreChild=(cardbody.childElementCount - 2)/2;
