          ...
          <nav class="sidebar-nav">
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="<?php echo site_url()?>manage-piece"
                  aria-expanded="false"
                  ><i class="mdi mdi-car-battery"></i
                  ><span class="hide-menu">gestion de pièce</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="<?php echo site_url()?>manage-kilometragevoiture"
                  aria-expanded="false"
                  ><i class="mdi  mdi-speedometer"></i
                  ><span class="hide-menu">Compte rendu</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="<?php echo site_url()?>manage-vehiculepiece"
                  aria-expanded="false"
                  ><i class="mdi mdi-ev-station"></i
                  ><span class="hide-menu">Etat voiture</span></a
                >
              </li>
